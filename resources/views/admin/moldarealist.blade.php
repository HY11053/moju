        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">模具适用范围列表</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <table class="table table-bordered table-striped text-center">
                        ...
                        <tr>
                            <td>{{$moldlist->id}}.</td>
                            <td>{{$moldlist->moldarea}}</td>
                            <td>{{$moldlist->created_at}}</td>
                          <td class="newcolor"> <span class="badge bg-red"><a href="/admin/moldareadel/{{$moldlist->id}}">删除</a> </span></td>
                        </tr>
                       @endforeach
                    </table>
                </div>
