        ...
        <ul class="timeline">
            ...
            <li>
                ...
                <div class="timeline-item">
                    ...
                    <h3 class="timeline-header"><a href="#">供应基本信息|</a> 按需填写</h3>

                    <div class="timeline-body basic_info">
                        <div class="form-group col-md-12">
                            {{Form::label('title', '供应信息标题', array('class' => 'control-label col-md-2 col-sm-3 col-xs-12'))}}
                            <div class="col-md-4 col-sm-9 col-xs-12">
                                {{Form::text('title', null, array('class' => 'form-control','id'=>'title','placeholder'=>'供应信息标题'))}}
                            </div>
                        </div>
                        <div class="form-group col-md-12">
                        ...
                        <div class="form-group col-md-12">
                            {{Form::label('description', '供应描述', array('class' => 'control-label col-md-2 col-sm-3 col-xs-12'))}}
                            <div class="col-md-4 col-sm-9 col-xs-12">
                ...
                <div class="timeline-item">
                    ...
                    <div class="timeline-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                {{Form::label('productname', '产品品牌', array('class' => 'control-label col-md-2 col-sm-3 col-xs-12'))}}
                                <div class="col-md-8 col-sm-9 col-xs-12">
                                    {{Form::text('productname', null, array('class' => 'form-control col-md-10','id'=>'productname','placeholder'=>'产品品牌'))}}
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                                {{Form::label('price', '产品单价', array('class' => 'control-label col-md-2 col-sm-3 col-xs-12'))}}
                                <div class="col-md-8 col-sm-9 col-xs-12">
                                    {{Form::text('price', null, array('class' => 'form-control col-md-10','id'=>'price','placeholder'=>'产品单价'))}}
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                                {{Form::label('mixnum', '最小起订', array('class' => 'control-label col-md-2 col-sm-3 col-xs-12'))}}
                                <div class="col-md-8 col-sm-9 col-xs-12">
                                    {{Form::text('mixnum', null, array('class' => 'form-control col-md-10','id'=>'mixnum','placeholder'=>'最小起订'))}}
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                                {{Form::label('senddate', '发货期限', array('class' => 'control-label col-md-2 col-sm-3 col-xs-12'))}}
                                <div class="col-md-8 col-sm-9 col-xs-12">
                                    {{Form::text('senddate', null, array('class' => 'form-control col-md-10','id'=>'senddate','placeholder'=>'发货期限'))}}
                                </div>
                            </div>
